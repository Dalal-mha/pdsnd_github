...
def get_filters():
    ...
    while (selected_city != "chicago" and selected_city != "new york city" and selected_city != "washington"):
     selected_city=input("please agin enter one of the following cities :Chicago, New York city, or Washington  \n").lower()   
    

    # TO DO: get user input for month (all, january, february, ... , june)
    selected_month =input("choose any month you want : January, February, March, April, May, June, or all?\n").lower() 
    # To make sure the entries are correct
    while(selected_month != 'all' and selected_month != 'january' and selected_month != 'february' and selected_month != 'march' and selected_month!= 'april' and selected_month != 'may' and selected_month != 'june'):
     selected_month=input("please agin enter any month you want : January, February, March, April, May, June, or all?\n").lower()
    
    
    # TO DO: get user input for day of week (all, monday, tuesday, ... sunday)
    selected_day=input("choose any day of the week you want : Monday, Tuesday,Wednesday, Thursday ,Friday ,Saturday or Sunday \n").lower() 
    #  TO make sure the entries are correct  
    while( selected_day != 'all' and  selected_day != 'monday' and  selected_day != 'tuesday' and  selected_day != 'wednesday' and  selected_day !='thursday' and  selected_day != 'friday' and  selected_day != 'saturday' and selected_day!='sunday' ):
      selected_day=input("please agin enter any day you want :Monday, Tuesday,Wednesday, Thursday ,Friday ,Saturday , Sunday or all?\n").lower()
